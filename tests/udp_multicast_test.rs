...
#[tokio::test]
async fn udp_multicast() {
    env_logger::Builder::from_env(env_logger::Env::default().default_filter_or("info")).init();

    let transport_a = build_transport("a", "0.0.0.0:54321", Some("239.0.0.1:54321")).await;
    let transport_b = build_transport("b", "0.0.0.0:54321", Some("239.0.0.1:54321")).await;
